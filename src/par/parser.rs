...
//                     let tok = self.peek_token()?;
//                     dbg!(&tok);
//                     if let Token::Newline = tok.token {
//                         break;
//                     } else if let Token::Plus = tok.token {
//                         let _plus = self.next_token(); // discard plus
//                         rhs.push(self.compound(side.clone())?);
//                     } else {
//                         break;
...
//                 if let Token::Newline = newline.token {
...
//         if peeked == Token::Newline || peeked == Token::RParen {
//             return Ok(ParseTree::Elementals { elementals });
//         }

//         loop {
//             if let Token::Newline = self.peek_token()?.clone().token {
//                 return Ok(ParseTree::Elementals { elementals });
//             }
...
//         dbg!(stdext::function_name!(), &side);
//         if let Token::LParen = self.peek_token()?.clone().token {
//             // nested
...
//         if let Token::Element(_) = val.token {
//             Ok(ParseTree::Element { val })
//         } else {
//             parse_error!(
//                 Reason::ExpectedDifferentToken {
//                     want: vec![Token::Element("".to_string())],
//                     got: val.clone().token
//                 },
//                 val
//             )
...
//         dbg!(stdext::function_name!());
//         let tok = self.peek_token()?;
//         if let Token::Number(_) = tok.token {
...
//         if let Token::Underscore = underscore.token {
//             let underscore = self.next_token()?;
//             let val = self.next_token()?;
//             if let Token::Number(_) = val.token {
//                 Ok(Some(ParseTree::Subscript { underscore, val }))
//             } else {
//                 parse_error!(
//                     Reason::ExpectedDifferentToken {
//                         want: vec![Token::Number("".to_string())],
//                         got: val.clone().token
//                     },
//                     val
//                 )
...
//         dbg!(stdext::function_name!());
//         let token = val.clone();
//         if let Token::Number(_) = token.token {
...
//         let t = token.clone();
//         match token.token {
//             Token::Caret => self.sugared_number_literal(hydrogen),
//             Token::String(_) => self.sugared_string_literal(hydrogen),
//             Token::LAngle => self.sugared_pair_literal(hydrogen),
//             Token::LBracket => self.sugared_list_literal(hydrogen),
//             Token::LBrace => self.sugared_map_literal(hydrogen),
//             Token::Element(symbol) => match symbol.as_str() {
...
//                     Reason::ExpectedDifferentToken {
//                         want: vec![
//                             Token::Element(String::from("Tr")),
//                             Token::Element(String::from("Fa")),
//                             Token::Element(String::from("O")),
//                             Token::Element(String::from("B")),
//                             Token::Element(String::from("S")),
//                             Token::Element(String::from("N")),
//                             Token::Element(String::from("C")),
//                         ],
//                         got: t.clone().token
//                     },
//                     t
...
//         let val = token.clone();
//         if let Token::Element(element) = token.token {
